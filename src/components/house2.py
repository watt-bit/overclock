...
class House2Component(ComponentBase):
    def __init__(self, x, y):
        ...
        # Load the image
        self.image = QPixmap(resource_path("src/ui/assets/house2.png"))
    ...
    def paint(self, painter, option, widget):
        ...
        shadow_x = rect.x() + (rect.width() - shadow_width) / 2 + 8
        shadow_y = rect.y() + rect.height() - shadow_height / 2 + self.shadow_y_offset - 20

...
import sys
import os
from PyQt6.QtWidgets import QWidget, QApplication, QVBoxLayout, QGraphicsView, QGraphicsScene, QGraphicsRectItem
from PyQt6.QtGui import QKeyEvent, QBrush, QPen, QPixmap, QGuiApplication
from PyQt6.QtCore import Qt, QTimer, pyqtSignal, QUrl, QSizeF
...
class AugurTitleScreen(QWidget):
    ...
    def __init__(self):
        ...
        # Create video item and media player using FFmpeg backend for all platforms
        ...
        # Load the video file - using same video file for all platforms
        video_path = resource_path("src/ui/assets/video/titlevideo7-2.mp4")
        video_url = QUrl.fromLocalFile(video_path)
        self.media_player.setSource(video_url)
        
        # Create and add black mask on top of everything
        self.black_mask = QGraphicsRectItem(0, 0, 1600, 900)
        self.black_mask.setBrush(QBrush(Qt.GlobalColor.black))
        self.black_mask.setPen(QPen(Qt.PenStyle.NoPen))  # No border
        ...
        # Setup auto-transition timer (10 seconds)
        self.timer = QTimer(self)
        self.timer.setSingleShot(True)
        self.timer.setInterval(13000)  # 13 seconds
        ...
        self.fade_to_black_timer.setInterval(11500)  # 11.5 seconds
